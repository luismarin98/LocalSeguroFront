...
export const ClientFeature: FC = () => {
    ...
    return (
        <div className="flex flex-row flex-wrap justify-around gap-2 w-full h-full items-center">
            <div className="grid grid-rows-4 grid-flow-col gap-4 place-items-center text-black">
                <button onClick={handleAddLocal} className={`flex flex-col items-center p-2 gap-2 bg-green-400 transition-all duration-105 hover:scale-105 rounded-md hover:shadow-md hover:shadow-neutral-900`}>
                ...
                <button onClick={handleAddMoto} className={`flex flex-col items-center p-2 gap-2 bg-green-400 transition-all duration-105 hover:scale-105 rounded-md hover:shadow-md hover:shadow-neutral-900`}>
