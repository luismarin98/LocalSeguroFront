...
export const CardUser = (data: UserRequest) => {
    const { openDelete, setOpenDelete, setUserId } = useContext(AdminContext) as IAdmin;
    ...
    return (
        <div className="bg-neutral-700 rounded-md w-[45vh] h-1/2 p-2 flex flex-row gap-2 justify-center - items-center">
