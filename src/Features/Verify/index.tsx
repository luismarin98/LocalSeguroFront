...
export const VerifyFeature: FC = () => {
    const initialValues: KeyRequest = { id_user: 0, key: '', id: 0 };
    ...
    return (
        <FormProvider {...method}>
            <div className="h-full w-full flex items-center justify-center">
                <form onSubmit={handleSubmit(submit)} className="bg-neutral-50 text-black flex flex-col gap-2 items-center rounded-md shadow-inner p-3 shadow-neutral-800 w-1/2 md:w-1/3">
