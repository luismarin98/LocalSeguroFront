    ...
    return (
        <div className="flex flex-row flex-wrap justify-around gap-2 w-full h-full items-center">
            <div className="flex flex-col gap-2">
                ...
                <button onClick={handleAddLocal} className={`flex flex-col items-center p-2 gap-2 bg-blue-400 transition-all duration-75 hover:scale-105 rounded-md hover:shadow-md hover:shadow-neutral-900`}>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-motorbike" width="100" height="100" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 16m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M19 16m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M7.5 14h5l4 -4h-10.5m1.5 4l4 -4" /><path d="M13 6h2l1.5 3l2 4" /></svg>
                    <p>Añadir moto</p>
                </button >
            </div>
            <div className="w-3/5 bg-slate-300 h-5/6 rounded-md">Lista de locales</div>
